    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="add-product-form" enctype="multipart/form-data">
            ...
            <div class="col-12">
        			<div class="form-group">
		        		<label>Is it New Fashion ?</label>
		        		<select class="form-control " name="new_fashion">
            ...
            <div class="col-12">
        			<div class="form-group">
		        		<label>Clearance Stock ?</label>
		        		<select class="form-control" name="clearance">
		        			<option value="">Select </option>
                  <option value="No">No </option>
                  <option value="Yes">Yes </option>
		        		</select>
        ...
        <form id="edit-product-form" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="col-12">
                <div class="form-group">
                    <label>Size</label>
                    <input type="text" name="e_product_size" class="form-control"
            ...
            <div class="col-12">
                <div class="form-group">
                    <label>Is it New Fashion ?</label>
                    <select class="form-control " name="e_new_fashion">
                        <option value="">Select</option>
                        <option value="No">No </option>
                        <option value="Yes">Yes </option>
                    </select>
            ...
            <div class="col-12">
                <div class="form-group">
                    <label>On Special Offer ?</label>
                    <select class="form-control " name="e_special_offer">
                        <option value="">Select</option>
                        <option value="No">No </option>
                        <option value="Yes">Yes </option>
                    </select>
            ...
            <div class="col-12">
                <div class="form-group">
                    <label>On Sale ?</label>
                    <select class="form-control " name="e_on_sale">
                        <option value="">Select</option>
                        <option value="No">No </option>
                        <option value="Yes">Yes </option>
                    </select>
            ...
            <div class="col-12">
                <div class="form-group">
                    <label>Clearance Stock ?</label>
                    <select class="form-control" name="e_clearance">
                        <option value="">Select </option>
                        <option value="No">No </option>
                        <option value="Yes">Yes </option>
                    </select>
            ...
            <div class="col-12">
                <div class="form-group">
                    <label>Item Type </label>
                    <select class="form-control" name="e_item_type">
                        <option value="">Select </option>
                        <option value="Shoes">Shoes</option>
                        <option value="Phone">Phone </option>
                        <option value="Laptop">Laptop </option>
